...
import com.superapp.tingtongapp.composetutorial.GameViewModel;
import com.superapp.tingtongapp.composetutorial.GameViewModel_HiltModules_KeyModule_ProvideFactory;
import com.superapp.tingtongapp.composetutorial.MainActivity;
import com.superapp.tingtongapp.composetutorial.MainRepository;
import com.superapp.tingtongapp.composetutorial.MainViewModel;
import com.superapp.tingtongapp.composetutorial.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApp_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(GameViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MainViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    private MainRepository mainRepository() {
      return new MainRepository(singletonCImpl.provideApiHelperProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.superapp.tingtongapp.composetutorial.GameViewModel", ((Provider) gameViewModelProvider)).put("com.superapp.tingtongapp.composetutorial.MainViewModel", ((Provider) mainViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new GameViewModel(viewModelCImpl.mainRepository());

          case 1: // com.superapp.tingtongapp.composetutorial.MainViewModel 
  ...
  private static final class SingletonCImpl extends MyApp_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.superapp.tingtongapp.composetutorial.di.ApiHelper 
          return (T) RetrofitModule_ProvideApiHelperFactory.provideApiHelper(singletonCImpl.apiHelperImpl());

          case 1: // com.superapp.tingtongapp.composetutorial.di.ApiService 
          return (T) RetrofitModule_ProvideApiServiceFactory.provideApiService(singletonCImpl.provideRetrofitProvider.get());

          case 2: // retrofit2.Retrofit 
          return (T) RetrofitModule_ProvideRetrofitFactory.provideRetrofit(singletonCImpl.provideOkHttpClientProvider.get(), RetrofitModule_BaseUrlFactory.baseUrl());
